...
Changelog from init baseline alone when no pending changes exist.
...
- Stdout is empty.
- Stderr is empty.
- No pending change files are moved ([D007](../DECISIONS.md#d007-apply-behavior)).
- Published version remains `1.2.3`.
