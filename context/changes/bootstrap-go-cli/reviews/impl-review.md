...
- **Decision**: DEFERRED — task 0011 created (`tasks/0011-fix-partial-conventional-config-not-merging-with-d.md`)
...
- **Decision**: DEFERRED — task 0012 created (`tasks/0012-reject-extra-positional-args-on-stub-subcommands.md`)
...
- **Decision**: DEFERRED — task 0013 created (`tasks/0013-treat-empty-since-flag-as-unset-in-config-loader.md`); recommended Fix A
...
- **Decision**: DEFERRED — task 0014 created (`tasks/0014-assert-exactly-four-subcommands-in-discovery-test.md`)
...
- **Decision**: DEFERRED — task 0015 created (`tasks/0015-add-automated-d011-failure-path-test.md`)
...
- **Decision**: DEFERRED — task 0016 created (`tasks/0016-add-test-for-malformed-config-file-error.md`)
