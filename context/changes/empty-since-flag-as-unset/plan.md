...
- [x] 1.1 Config package tests pass: `go test ./internal/config/...` — 0f1e842
- [x] 1.2 Full test suite passes: `task test` — 0f1e842
- [x] 1.3 Formatting, vet, module tidiness, and lint checks pass: `task doctor` — 0f1e842

#### Manual

- [x] 1.4 None beyond automated verification; review the automated test results — 0f1e842
